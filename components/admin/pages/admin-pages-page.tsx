  ...
  return (
    <div className="mx-auto w-full max-w-6xl p-4 md:p-8">
      <div className="mb-6 flex flex-col gap-2">
        ...
        <p className="text-sm text-slate-400">{pages.length} page{pages.length !== 1 ? "s" : ""}</p>
        <p className="text-sm text-slate-500">Les pages du site sont gérées par l'équipe technique. Vous pouvez modifier leur contenu.</p>
      </div>
